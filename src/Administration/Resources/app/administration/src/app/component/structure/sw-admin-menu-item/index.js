...
export default {
    ...
    computed: {
        ...
        /**
         * Collapsed sidebar: only flyout sub-trees need collapsible nesting.
         * Expanded sidebar: level 1 and 2 folders use mt-collapsible (max depth 3).
         */
        usesCollapsible() {
    ...
    methods: {
        ...
        /** Collapsed sidebar (level 1) and non-collapsible rows */
